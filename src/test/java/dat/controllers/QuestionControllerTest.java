...
class QuestionControllerTest
{
    ...
    private final Logger logger = LoggerFactory.getLogger(QuestionControllerTest.class.getName());
    ...
    void setUp()
    {
        try (EntityManager em = emf.createEntityManager())
        {
            ...
            test_q1 = test_dao.create(new Question("test question", 10));
            test_q2 = test_dao.create(new Question("test question 2", 5));
